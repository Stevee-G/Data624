...
```{r}
url1 <- "https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Fotexts.com%2Ffpp3%2Fextrafiles%2Ftourism.xlsx&wdOrigin=BROWSELINK"
tourism1 <- readxl::read_excel(url1)
View(tourism1)
```
